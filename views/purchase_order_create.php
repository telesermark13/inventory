<?php
// zaiko/views/purchase_order_create.php
            ...
            <table class="table table-bordered table-sm">
                <thead class="table-light">
                    <tr>
                        <th>Item</th>
                        <th>SKU</th>
                        <th>Serial Number</th> <th>Unit</th>
                ...
                <tbody>
                    ...
                    ?>
                        <?php if ($outstanding_qty > 0): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($item['serial_number'] ?? 'N/A') ?></td> <td><?= htmlspecialchars($item['unit']) ?></td>
                    ...
                    <?php if (empty(array_filter($po_items, fn($i) => ((float)$i['quantity'] - (float)$i['quantity_received_val']) > 0))): ?>
